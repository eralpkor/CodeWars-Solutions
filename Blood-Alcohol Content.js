...
https://www.codewars.com/kata/blood-alcohol-content/train/javascript
...
function bloodAlcoholContent({ounces, abv}, weight, sex, time) {
  if (sex === 'male') {
    return +(ounces * abv * 5.14 / weight * (0.73) - 0.015 * time).toFixed(4)
  }
    return +(ounces * abv * 5.14 / weight * (0.66) - 0.015 * time).toFixed(4);
}


var bloodAlcoholContent = ({ ounces, abv }, weight, sex, time) =>
  Number((ounces * abv * 5.14 / weight * (sex === 'male' ? 0.73 : 0.66) - 0.015 * time).toFixed(4));